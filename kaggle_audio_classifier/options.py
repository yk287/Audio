...
class options():
    ...
    def initialize(self):
        ...
        # Training Options
        self.parser.add_argument('--epoch', type=int, nargs='?', default=350, help='total number of training episodes')
        ...
        self.parser.add_argument('--split', type=float, nargs='?', default=0.20, help='proportion of test split')
        ...
        self.parser.add_argument('--SR', type=int, nargs='?', default=12000, help='number of conv up')
        self.parser.add_argument('--N_FFT', type=int, nargs='?', default=512, help='number of conv up')
        self.parser.add_argument('--N_MELS', type=int, nargs='?', default=96, help='number of conv up')
        self.parser.add_argument('--HOP_LEN', type=int, nargs='?', default=256, help='number of conv up')
        self.parser.add_argument('--DURA', type=int, nargs='?', default=1000, help='number of conv up')

        self.parser.add_argument('--dir', type=str, nargs='?', default='/home/youngwook/Documents/audio/train/audio/',
                                 help='file directory')
        self.parser.add_argument('--dict_name_0', type=str, nargs='?', default='name_to_label_dict',
                                 help='name_to_label_dict dictionary filename')
        self.parser.add_argument('--dict_name_1', type=str, nargs='?', default='label_to_name_dict',
                                 help='label_to_name_dict dictionary filename')
        self.parser.add_argument('--model_path', type=str, nargs='?', default='./model',
                                 help='file directory')
